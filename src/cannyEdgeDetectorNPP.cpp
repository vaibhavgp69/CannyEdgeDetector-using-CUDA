...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    if (checkCmdLineFlag(argc, (const char **)argv, "input")) {
      ...
      filePath = sdkFindFilePath("./data/tesla_cybertruck.pgm", argv[0]);
    }

    if (filePath) {
      sFilename = filePath;
    } else {
      sFilename = "./data/tesla_cybertruck.pgm";
    }
    ...
    std::string sResultFilename = "./output_images/tesla_cybertruck.pgm";
